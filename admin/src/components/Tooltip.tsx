    ...
    return (
        ...
        >
            ...
            {isVisible && (
                <div
                    role="tooltip"
                    className={`absolute z-50 px-3 py-2 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 rounded-lg shadow-sm whitespace-nowrap ${positionClasses[position]}`}
                >
                    {content}
                    <div
