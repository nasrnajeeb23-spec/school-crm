                                        ...
                                        <tr key={member.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center justify-center gap-2 flex-wrap">
                                                    ...
                                                    <button
                                                        onClick={() => setTimesheetOpen({ id: String(member.id), name: member.name })}
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="w-full max-w-xl bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">تفاصيل دوام الموظف: {timesheetOpen.name}</h3>
                        ...
                        <div className="mt-6 flex justify-end gap-2">
                            ...
                            <button
                                onClick={async () => {
                                    ...
                                    setTsSaving(true);
                                    try {
                                        await api.createStaffAttendance(schoolId, {
                                            userId: timesheetOpen.id,
                                            date: selectedDate,
