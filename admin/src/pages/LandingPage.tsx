...
const featureIconMap: { [key: string]: React.ElementType } = {
  'f1': StudentsIcon, 'f2': FinanceIcon, 'f3': PermissionsIcon, // HR icon placeholder
  'f4': ServerIcon, // Transport/Bus icon placeholder
  'f5': StudentsIcon, // Mobile App icon placeholder
  'f6': ReportsIcon,
};
        ...
        <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm sticky top-0 z-40">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <button onClick={() => setIsMobileMenuOpen(v => !v)} className="md:hidden p-2 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" aria-label="فتح القائمة" aria-expanded={isMobileMenuOpen}
              >
