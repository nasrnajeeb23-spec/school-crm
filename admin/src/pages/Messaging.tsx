                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            {currentMessages.length === 0 ? (
                                ...
                                currentMessages.map(message => (
                                    ...
                                    >
                                        <div
                                            className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${message.senderId === 'me' ? 'bg-teal-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white'}`}
                                        >
                                            <p>{message.text}</p>
                                            <p className={`text-xs mt-1 ${message.senderId === 'me' ? 'text-teal-100' : 'text-gray-500 dark:text-gray-400'}`}>
